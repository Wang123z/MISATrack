...
class DTBVideo(Video):
    ...
    def __init__(self, name, root, video_dir, init_rect, img_names,
        ...
        super(DTBVideo, self).__init__(name, root, video_dir,
...
def ca():
    ...
    path='/home/wyb/HiFT/tools/../../../../raid/datasets/DTB70'
...
class DTBDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        super(DTBDataset, self).__init__(name, dataset_root)
        ...
        for video in pbar:
            ...
            self.videos[video] = DTBVideo(video,
                                          dataset_root,
