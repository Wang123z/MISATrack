...
class OPEBenchmark:
    ...
    def eval_precision(self, eval_trackers=None):
        ...
        for tracker_name in eval_trackers:
            ...
            for video in self.dataset:
                ...
                # cle_plotter.save_plot(video.name)
    ...
    def draw_cle(self, dataset=None,eval_trackers=None):
        """
        Args:
            eval_trackers: list of tracker name or single tracker name
        Return:
        ...
        for tracker_name in eval_trackers:
            for video in self.dataset:
                ...
                # if video.name in ['S0901','S1604']:
                #     cle_plotter = CLEPlotter(gt_center=gt_center, tracker_center=tracker_center)
                #     cle_plotter.save_plot(dataset,video.name)
    ...
    def eval_norm_precision(self, eval_trackers=None):
        ...
        for tracker_name in eval_trackers:
            ...
            for video in self.dataset:
                ...
                # cle_plotter = CLEPlotter(gt_center=gt_center_norm, tracker_center=tracker_center_norm)
                # cle_plotter.save_plot(video.name)
